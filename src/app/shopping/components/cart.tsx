...
export const Cart = () => {
    ...
    return (
        <div className="container p-6 sm:p-4 w-full mx-auto">
            <div className="overflow-x-auto">
                {cartItems.length > 0 ? (
                    <>
                    <span className="flex font-eb_garamond font-semibold text-black text-xl pb-4">
                        Total Quantity: {cartTotalQuantity}
                    </span><table className="w-full bg-white border border-gray-200 p-6">
                            <thead>
                            ...
                            <tbody>
                                {cartItems.map((item, index) => (
                                    <tr key={index} className="border-b border-gray-200 p-6">
                                        <td className="p-3">
                                            <img
            ...
            {cartItems.length > 0 && (
                <div className="flex flex-col sm:flex-row justify-between items-center">
                    ...
                    <div className="text-base sm:text-lg font-bold border-2 mt-4 p-2 sm:p-4">
